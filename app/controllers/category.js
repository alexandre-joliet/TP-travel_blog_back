...
const categoryController = {
  ...
  async createOneCategory (request, response, next) {
    ...
    const { error, newCategory } = await categoryDataMapper.addNewCategory(value, creator);
  ...
  async deleteOneCategory (request, response, next) {
    ...
    const { error, deletedCategory } = await categoryDataMapper.deleteOneCategory(id);
...
;
    const { error, updatedCategory } = await categoryDataMapper.updateOneCategory(id, label);
  ...
  async getAllArticlesByCategory (request, response, next) {
    ...
    const { error, articlesByCategory } = await categoryDataMapper.getAllArticlesByCategory(id);
